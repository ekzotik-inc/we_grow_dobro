...
# Символы, у которых премиальная версия из набора не похожа на оригинал: такие показываем
# обычными — лучше обычный, но верный по смыслу. Правильную картинку можно закрепить
# командой /emojifix, не трогая код.
